...
def create_files(base_path):
    files = {
        ...
        "Ma2tA/ma2ta/settings.py": settings_py_content,
...
settings_py_content = '''"""
Django settings for ma2ta project.
...
if __name__ == '__main__':
    base_path = "/home/ma2ta/Ma2tA"
    create_folder_structure(base_path)
    create_files(base_path)
    print("Part 1 of the Ma2tA project setup completed.")